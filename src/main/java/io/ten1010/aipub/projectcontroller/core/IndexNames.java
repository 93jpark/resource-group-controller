...
public final class IndexNames {
    ...
    public static final String BY_NAMESPACE_NAME_TO_IMAGE_NAMESPACE_GROUP_OBJECT = "BY_NAMESPACE_NAME_TO_IMAGE_NAMESPACE_GROUP_OBJECT";
    public static final String BY_NAMESPACE_NAME_TO_IMAGE_NAMESPACE_GROUP_BINDING_OBJECT = "BY_NAMESPACE_NAME_TO_IMAGE_NAMESPACE_GROUP_BINDING_OBJECT";
